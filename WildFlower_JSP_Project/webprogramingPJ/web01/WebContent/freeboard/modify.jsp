...
<jsp:useBean id="vo1" class="freeboard.VO" />
...
<body style="max-width: 650px">
	...
	<!-- header부분 -->
	<header> <%@ include file="../wildflower/header.jsp"%>
	</header>

	<!-- contents 부분 -->
	<div class="w3-container" style="margin-top: 75px">
		<h3 class="w3-text-red">
			<img src="../image/daisy.png" height="20px" width="20px" />글 수정
		</h3>
		<hr>
		<p>
			* 글 수정은 <b>제목</b>과 <b>내용</b>만 할 수 있습니다.
		</p>
		<table>
			<form name=modifyform method=post
				...
				<tr height="1" bgcolor="#F44336">
					<td colspan="4"></td>
				</tr>
				<tr align="center">
					<td>&nbsp;</td>
					<td colspan="2"><input type="button" class="button button2"
						value="수정" OnClick="javascript:modifyCheck();"> <input
						type="button" class="button button2" value="취소"
	...
	<!-- footer부분 -->
	<footer class="w3-container w3-theme w3-bottom"> <%@ include
		file="../wildflower/footer.jsp"%> </footer>
