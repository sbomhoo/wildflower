...
<%
	...
	String fullpath = vo.getUploadPath() + "/" + vo.getFilename();
%>
      ...
      <td width="0">&nbsp;</td>
                   ...
                   <%
                   	if(vo.getFilename() == null){
                   		...
                   		%>
                   	<img src="../uploadImg/<%=vo.getFilename()%>" width=512 height=324></img><br/>
                   	<%	}  %>
     ...
     <tr align="center" width="100%">
      ...
      <td colspan="2">
		...
		<% if(session.getAttribute("id")==null){%>
			...
			<input type=button class="button button2" value="목록" OnClick="window.location='qna.jsp?pg=<%=pg%>'">
		<% }else{ %>	
