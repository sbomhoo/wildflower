 ...
 * Generated at: 2017-09-07 09:46:17 UTC
...
public final class qna_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/qnaboard/../wildflower/header.jsp", Long.valueOf(1482394836000L));
    _jspx_dependants.put("/qnaboard/../wildflower/footer.jsp", Long.valueOf(1481619576000L));
  }
  ...
  static {
    ...
    _jspx_imports_packages.add("qnaboard");
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      qnaboard.DAO dao = null;
      dao = (qnaboard.DAO) _jspx_page_context.getAttribute("dao", javax.servlet.jsp.PageContext.PAGE_SCOPE);
      if (dao == null){
        dao = new qnaboard.DAO();
 ...
 out.println(session.getAttribute("id") + " 님 환영합니다"); 
      ...
      out.write("\t\t<p>&nbsp;&nbsp;&nbsp;&nbsp; 야생화의 이름을 질문할 수 있는 게시판입니다.</p>\r\n");
      out.write("\t<hr>\r\n");
      out.write("\r\n");
	...
	if(total==0) {
      ...
      out.write("\r\n");
      out.write("\t\t\t[<a href=\"qna.jsp?pg=1\">◀◀</a>]\r\n");
      out.write("\t\t\t[<a href=\"qna.jsp?pg=");
